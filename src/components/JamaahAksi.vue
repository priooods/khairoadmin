            ...
            <div v-if="checkval == 1">
              <h1 class="mt-2">Detail Jamaah</h1>
                <div class="mt-3" v-if="detail.bayar !== 'LUNAS'">
                  <vs-button size="small" block v-show="closeshow == 0" @click="closeshow = 1">Bayar Tagihan</vs-button>
                  <div class="mt-3" v-show="closeshow == 1">
                    ...
                    <div class="row mt-3">
                      <vs-button size="small" class="col" block @click="bayarr" success>Bayar</vs-button>
                      <vs-button size="small" class="col" block @click="closeshow = 0" danger>Tutup</vs-button>
                    </div>
                  </div>
                </div>
                <div class="mt-3" v-if="detail.hotel_id == null">
                  <vs-button size="small" block v-show="closeshow == 0" @click="callUmrahdetail">Tambah Detail</vs-button>
                  <div class="row" v-show="closeshow == 3">
                    ...
                    <div class="col-12 row mt-3">
                      <vs-button size="small" class="col" block @click="updatedetails" success>Update</vs-button>
                      <vs-button size="small" class="col" block @click="closeshow = 0" danger>Tutup</vs-button>
                    </div>
                  </div>
                </div>
